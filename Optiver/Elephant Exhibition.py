# -*- coding = utf-8 -*-
# @Time : 10/20/2023 9:53 PM
# @Author : Lauren
# @File : Elephant Exhibition.py
# @Software : PyCharm
...
class ElephantCompetition:
    ...
    def getBiggestElephants(self, time):
        ...
        while self.si < len(self.schedule) and self.schedule[self.si][
            1] <= time:
        ...
        candidates = [name for name, height in self.mine if
                      height >= tallestRival]
        candidates.sort()
        return candidates
